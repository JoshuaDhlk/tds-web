  ...
  <section id="home">
    <div class="home container">
      <div>
        ...
        <a href="#projects" type="button" class="clickable">Portfolio</a>
      </div>
    </div>
  </section>
  <!-- End Home Section  -->
  ...
  <section id="projects">
    <div class="projects container">
      <div class="projects-header">
        <h1 class="section-title">Projets <span>récents</span></h1>
      </div>
      <div class="all-projects">
        <div class="project-item">
          ...
          <div class="project-img">
            <img src="./img/projets.JPG" alt="img"> <!-- temporaire-->
          </div>
        </div>
        <div class="project-item">
          <div class="project-info">
  ...
  <section id="about">
    <div class="about container">
      ...
      <div class="col-right">
        ...
        <a href="file:///D:/BTS%20SIO/Developpement/tds-web-main/Projets%20cours/Portfolio/img/CV%20Joshua%20Dahlke.pdf" class="clickable">Télécharger CV</a>
      </div>
    </div>
  </section>
  <!-- End About Section -->
