  ...
  <section id="presentations">
    <div class="presentations container">
      <div class="presentation-top">
        ...
        <div class="box">
          <dic class="inbox">
            <h2>Bonjour, je vous souhaite la bienvenue. Je m'appelle Joshua j'ai 18 ans et je suis en ce moment en 1ere année de <strong>BTS SIO (Services Informatiques aux Organisations)</strong>. J'ai opté pour l'option <strong>SLAM (Solutions Logicielles et Applications Métiers)<strong> dans l'établissement Sainte-Ursule de Caen. Le plaisir que me procure le domaine du développement web a fait surface lors d'un stage en Allemagne.</h2>
          </div>
        </div>
    </div>
  </section>
...
<section id="competences">
  <div class="presentations container">
    <div class="presentation-top">
      <h1 class="section-title"><span>Com</span>pétence<span>s</span></h1>
      <div class="skill">
  ...
  <section id="formations">
    <div class="formations container">
      <div class="formations-header">
        <h1 class="section-title"><span>For</span>matio<span>n</span></h1>
      </div>
      <div class="all-formations">
        <div class="formation-item">
          <div class="formation-info">
            <h1>Lycée</h1>
            <h2>Lycée Saint-Ouen, Pont-Audemer (Bac Général) avec les spécialités: Mathématiques, SVT</h2>
            <p>De 2019 à 2022</p>
          </div>
        ...
        <div class="formation-item">
          <div class="formation-info">
            <h1>Premier Stage</h1>
            <h2>Nestlé (NDC Lisieux), développement produits laitiers international</h2>
            <p>Stage d'une semaine en 2019 en 3ème</p>
            <p></p>
          </div>
          <div class="formation-img">
          ...
          <div class="formation-item">
            <div class="formation-info">
              <h1>Second Stage</h1>
              <h2>Stage en Allemagne d'une semaine en 2021</h2>
              <h2> Unit.Cloud, Augsburg - solutions informatiques</h2>
              <p>Hors période scolaire</p>
            </div>
            <div class="formation-img">
  ...
  <section id="footer">
    ...
    <h4 class="droits">ⓒ2022. Joshua D. All Right Reserved \ Privacy policy</h4>
  </section>
  <!-- End Footer -->
